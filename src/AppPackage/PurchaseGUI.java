...
public class PurchaseGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField_purchasecreatequantity.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextField_purchasecreatequantityKeyTyped(evt);
            }
        });
        ...
        jTextField_purchasecreatediscount.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextField_purchasecreatediscountKeyTyped(evt);
            }
        });
    ...
    private void jTextField_purchasecreatediscountKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_purchasecreatediscountKeyTyped
        char cr = evt.getKeyChar();
        if(!(Character.isDigit(cr) || cr == KeyEvent.VK_BACK_SPACE || cr == KeyEvent.VK_DELETE || cr == '.')){
            getToolkit().beep();
            evt.consume();            
        }
    }//GEN-LAST:event_jTextField_purchasecreatediscountKeyTyped

    private void jTextField_purchasecreatequantityKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_purchasecreatequantityKeyTyped
        char cr = evt.getKeyChar();
        if(!(Character.isDigit(cr) || cr == KeyEvent.VK_BACK_SPACE || cr == KeyEvent.VK_DELETE || cr == '.')){
            getToolkit().beep();
            evt.consume();            
        }
    }//GEN-LAST:event_jTextField_purchasecreatequantityKeyTyped
